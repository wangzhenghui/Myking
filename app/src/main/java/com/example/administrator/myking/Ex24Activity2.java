 ...
 */
public class Ex24Activity2 extends Activity {
    String[] s={"辽宁","吉林","黑龙江"};
    String[][] c={{"沈阳","阜新","大连"},{"吉林","四平","长春"},{"齐齐哈尔","漠河","大庆","讷河"}};
    ExpandableListView elv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ex24_layout2);
        ...
        ExpandableListAdapter e=new ExpandableListAdapter() {
            ...
            public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
                TextView v=new TextView(Ex24Activity2.this);
