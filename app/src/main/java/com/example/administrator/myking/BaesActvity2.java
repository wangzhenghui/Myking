...
public class BaesActvity2 extends BaseActivity {
    ...
    "SQLite查询信息","图片缩放","手势保存","手势识别","百度语音朗读TTS","学生信息增删改","飞机大战","播放音乐","绑定方式启动Servie获取数据","SoundPool播放音频"
    ,"MediaPlayer和SurfaceView播放视频","录音播放","录制视频","股票代码查询","上传学生信息","指南针","摇一摇"};
    ListView lv;
    ...
    Ex28Activity.class,Ex29Activity.class,Ex30Activity.class,Ex30Activity3.class,Ex31Activity.class,MainActivity4.class,GPanlewarActivity1.class,Ex34Activity.class,Ex33Activity.class,Ex35Activity.class
    ,Ex36Activity.class,Ex37Activity.class,Ex38Activity.class,Ex39Activity.class,Ex40Activity.class,CompassTestActivity.class,Ex42Activity.class};
   @Override
