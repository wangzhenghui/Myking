 ...
 */
public class Ex42Activity extends Activity {
    Ex42weixinActivity mShakeListener = null;
    Vibrator mVibrator;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mShakeListener = new Ex42weixinActivity(Ex42Activity.this);
        mShakeListener.setOnShakeListener(new Ex42weixinActivity.OnShakeListener() {
            public void onShake() {
    ...
    public void startVibrato(){
        MediaPlayer player;
        player = MediaPlayer.create(this, R.raw.welcome1);
