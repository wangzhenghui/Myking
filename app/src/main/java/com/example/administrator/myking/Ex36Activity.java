 ...
 */
public class Ex36Activity extends BaseActivity implements View.OnClickListener{
    SurfaceView sv;
    Button play;
    Button pause;
    Button stop;
    ...
    public void play() throws IOException {
        ...
        player.setDataSource("/mnt/sdcard/video/myvideo.mp4");
        //player.setDataSource("/mnt/sdcard/video/mm.mp4");
